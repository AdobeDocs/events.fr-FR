...
Organisé en partenariat avec Enterprise Architecture, ce webinaire partageait les bonnes pratiques, conseils, astuces et secrets pour améliorer la supervision et les opérations de votre instance Workfront.

Axée sur la gouvernance (pensez aux conventions de nommage), l’exécution (processus et automatisations) et l’adoption (modèles de disposition, vues, filtres et regroupements), cette session a été riche en conseils utiles pour vous assurer que vous êtes prêt à utiliser Workfront.
