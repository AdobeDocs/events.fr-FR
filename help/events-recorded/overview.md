    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="CX Analytics On-demand Webinars">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/docs/events/cx-analytics-ondemand-webinars/overview.html?lang=fr" target="_blank" rel="referrer" title="Webinaires à la demande CX Analytics">Webinaires à la demande </a>
                    </p>
                    <p class="is-size-6">Parcourez des vidéos CX Analytics à la demande couvrant les mises à jour de produits, les intégrations, l’intégration et des témoignages de clients réels pour rester à jour et développer votre expertise.</p>
                </div>
