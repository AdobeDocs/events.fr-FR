---
title: Maîtriser les canaux marketing et l’attribution
description: Découvrez les subtilités de la configuration des canaux marketing dans Adobe Analytics. Tirez parti des modèles d’attribution pour fournir des informations exploitables pour votre stratégie marketing.
solution: Analytics
...
# Maîtriser les canaux marketing et l’attribution dans Adobe Analytics

Dans le contexte actuel du marketing numérique qui évolue rapidement, il est essentiel de déchiffrer la manière dont les utilisateurs découvrent et interagissent avec votre site web ou votre application mobile pour optimiser les campagnes et accroître le retour sur investissement. Cette session abordera en détail les complexités de la configuration des canaux marketing dans Adobe Analytics et de l’utilisation de modèles d’attribution pour fournir des informations exploitables pour votre stratégie marketing.
