---
title: 'Apaiser le chaos client : conseils pour faire face à des Parcours complexes dans Adobe Journey Optimizer'
...
|------------------------|-------------------------------|---------------------------|
| Noms longs et déroutants | Conventions de dénomination manuelles | Utiliser les balises et les catégories |
| Exécution incohérente | Erreur humaine dans l’affectation de nom | Application de la gouvernance des balises |
| Parcours difficiles à trouver | Noms trop détaillés | Filtrer par balises |
| Défis liés au reporting | Utilisation de noms pour les rapports | Combinaison de balises et de noms concis |
