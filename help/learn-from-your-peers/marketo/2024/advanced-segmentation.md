...
* [Création d’une segmentation](https://experienceleague.adobe.com/fr/docs/marketo/using/product-docs/personalization/segmentation-and-snippets/segmentation/create-a-segmentation){target="_blank"}
* [Modification d’une segmentation](https://experienceleague.adobe.com/fr/docs/marketo/using/product-docs/personalization/segmentation-and-snippets/segmentation/edit-a-segmentation){target="_blank"}
