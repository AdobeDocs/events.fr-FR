...
description: Principal de la segmentation séquentielle et des filtres dans AA et CJA avec des aspects fondamentaux, des exemples pratiques et des applications commerciales, comme traité dans la session d’Andy Powers.
...
* **Session Focus** La session était axée sur la maîtrise de la logique séquentielle et de l’analyse dans Customer Journey Analytics (CJA), sous la direction d’Andy Powers.
...
* **Ressources** Des liens vers des ressources pour les analyses et les CJA des segments ou filtres séquentiels ont été fournis pour une étude plus approfondie.
