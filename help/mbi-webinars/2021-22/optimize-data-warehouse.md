...
landing-page-description: Regardez ce webinaire enregistré sur .
short-description: Regardez ce webinaire enregistré sur .
kt: 10403
...
À l’aide du gestionnaire Data Warehouse, vous pouvez gérer les paramètres de synchronisation des tableaux et des colonnes, explorer le schéma d’un tableau et créer des colonnes calculées à utiliser dans les rapports.

>[!NOTE]
>
>L’accès au gestionnaire Data Warehouse requiert des autorisations d’administrateur.

Dans ce webinaire :

- Présentation du Data Warehouse
- Cycle de mise à jour et optimisation
- Réplication et revérifications
- Vues Data Warehouse
...
[Optimisation de votre base de données pour l&#39;analyse](https://experienceleague.adobe.com/docs/commerce-business-intelligence/mbi/best-practices/data/opt-db-analysis.html?lang=fr)
